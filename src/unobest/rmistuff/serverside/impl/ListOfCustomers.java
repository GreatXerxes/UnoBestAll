...
public class ListOfCustomers {
    ...
    void load() {
        ...
        try {
            ...
            System.out.println("Customers in file");
    ...
    public boolean isAdmin(String u)
    {
        if(customerExist(u))
        {
            return customers.get(u).isAdmin();
    ...
    public boolean isSuperAdmin(String u)
    {
        if(customerExist(u))
        {
            return customers.get(u).isSuperAdmin();
    ...
    public void makeAdmin(String username)
    {
        ...
        {
            customers.get(username).makeAdmin();
            saveCustToFile();
        }
    }
    ...
    public void revertAdmin(String username)
    {
        if(customerExist(username))
        {
            customers.get(username).revertAdmin();
            saveCustToFile();
        }
    }
    ...
    public void addRouteToWatchList(String username, String route)
    {
        if (customerExist(username))
        {
            customers.get(username).addRouteToWatchList(route);
            saveCustToFile();
        }
    }
}
